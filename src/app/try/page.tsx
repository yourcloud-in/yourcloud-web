...
export default function TryPage() {
  ...
  const steps = [
    ...
    'Mounting filesystem...',
    'Starting YourCloud demo environment...',
    ...
    <div className="min-h-screen bg-[#0A1628] text-white flex flex-col">
      ...
      <div className="flex items-center justify-between px-6 py-3 border-b border-white/10 bg-[#0D2137]">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/pricing"
            className="text-xs bg-[#1D9E75] text-white px-4 py-1.5 rounded-lg hover:bg-[#0F6E56] transition-colors font-medium">
            Get started free →
          </Link>
        </div>
      </div>
      ...
      <div className="text-center py-8 px-4">
        ...
        <h1 className="text-3xl font-bold text-white mb-2">Try YourCloud Instantly</h1>
        ...
        <div className="flex-1 flex flex-col">
          <div className="bg-[#0D2137] rounded-t-xl border border-white/10 px-4 py-2.5 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-gray-400 ml-2">yourcloud-demo — bash</span>
            </div>
          ...
          {!loaded && (
            <div className="flex-1 bg-black rounded-b-xl border border-t-0 border-white/10 flex flex-col items-center justify-center gap-4 min-h-[500px]">
              ...
              <button onClick={() => setLoaded(true)}
                className="mt-4 text-xs text-[#1D9E75] border border-[#1D9E75]/30 px-5 py-2 rounded-lg hover:bg-[#1D9E75]/10 transition-colors">
                Launch VM now →
              </button>
            </div>
          )}
        ...
        <div className="w-72 flex-shrink-0 flex flex-col gap-4">
          ...
          <div className="bg-[#1D9E75]/5 border border-[#1D9E75]/20 rounded-xl p-4">
            <div className="flex items-center gap-2 mb-2">
              <span>🛡️</span>
              <span className="text-xs font-semibold text-white">DPDP Safe</span>
              <span className="ml-auto text-xs text-[#1D9E75] bg-[#1D9E75]/10 px-2 py-0.5 rounded-full">Verified</span>
            </div>
            <p className="text-xs text-gray-400 leading-relaxed">
              This demo runs entirely in your browser via WebAssembly.
              No data is sent to our servers. Your commands stay on your device.
            </p>
          </div>
          ...
          <div className="bg-[#0D2137] border border-white/10 rounded-xl p-4">
            <div className="flex items-center gap-2 mb-2">
              <span>☀️</span>
              <span className="text-xs font-semibold text-white">Solar Powered</span>
            </div>
            <p className="text-xs text-gray-400 leading-relaxed mb-2">
              The real YourCloud runs on 100% solar in Bhubaneswar, Odisha.
              Zero carbon footprint for your production VMs.
            </p>
            <div className="h-1.5 bg-gray-800 rounded-full overflow-hidden">
              <div className="h-full bg-[#1D9E75] w-full rounded-full" />
            </div>
            <div className="flex justify-between text-xs text-gray-500 mt-1">
              <span>Grid usage</span>
              <span className="text-[#1D9E75]">0% · 100% solar</span>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-[#1D9E75]/20 to-[#1565C0]/20 border border-[#1D9E75]/30 rounded-xl p-4 text-center">
            ...
            <p className="text-xs text-gray-400 mb-3">
              Deploy a real VM in 60 seconds. 3 months free for beta users.
            </p>
            <Link href="/pricing"
              className="block w-full bg-[#1D9E75] text-white text-xs font-semibold py-2.5 rounded-lg hover:bg-[#0F6E56] transition-colors">
      ...
      <div className="border-t border-white/10 bg-[#0D2137] px-6 py-3 flex items-center justify-between text-xs text-gray-500">
        <span>
          Powered by{' '}
          <a href="https://webvm.io" target="_blank" rel="noopener noreferrer" className="text-[#1D9E75] hover:underline">WebVM</a>
          {' '}(Apache 2.0) · Full Linux via WebAssembly
        </span>
        <span>YourCloud · Bhubaneswar, Odisha · DPDP Compliant · 100% Solar</span>
      </div>
