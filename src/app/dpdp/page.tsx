...
const PILLARS = [
  { icon: '🇮🇳', title: 'Physical Data Sovereignty', status: 'Verified',
  ...
  { icon: '👤', title: 'Data Principal Rights', status: 'Honoured',
    ...
    detail: 'No automated rejection of data requests. Babrit Behera personally reviews all DPDP rights requests at ceo@gravrel.com.' },
  ...
  { icon: '📝', title: 'Data Processing Agreements', status: 'Available',
    ...
    detail: 'DPA template available immediately. Customisation within 48 hours. Email ceo@gravrel.com to request.' },
];
    ...
    <div className="min-h-screen bg-[#0A1628] text-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-20 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="/pricing" className="bg-[#1D9E75] text-white px-6 py-3 rounded-xl font-semibold text-sm hover:bg-[#0F6E56] transition-all">
              Start free — DPDP included →
            </Link>
            <a href="mailto:ceo@gravrel.com" className="bg-white/5 border border-white/15 text-white px-6 py-3 rounded-xl font-semibold text-sm hover:bg-white/10 transition-all">
      ...
      <div className="border-y border-white/10 bg-[#0D2137]/50">
        <div className="max-w-6xl mx-auto px-6 py-5 flex flex-wrap items-center justify-center gap-8 text-sm">
          {[
            ['🇮🇳', 'Data physically in Bhubaneswar, Odisha'],
            ['📋', 'UDYAM-OD-03-0020346'],
            ['☀️', '100% Solar Powered'],
            ['👤', 'CEO reachable — ceo@gravrel.com'],
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-gray-400 leading-relaxed mb-6">
              Non-compliance carries fines of up to <span className="text-white font-semibold">Rs 250 crore per violation</span>.
            ...
            <div className="bg-[#1D9E75]/5 border border-[#1D9E75]/20 rounded-xl p-5 space-y-2">
              {[
                ...
                'Maximum fine: Rs 250 crore per violation',
          ...
          <div className="space-y-4">
            <div className="bg-[#0D2137] border border-white/10 rounded-2xl p-6">
              <div className="text-4xl font-bold text-[#1D9E75] mb-1">Rs 250Cr</div>
      ...
      <section className="bg-gradient-to-br from-[#1D9E75]/15 to-[#1565C0]/10 border-t border-[#1D9E75]/20 py-20">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="/pricing" className="bg-[#1D9E75] text-white px-8 py-3.5 rounded-xl font-semibold hover:bg-[#0F6E56] transition-all">
              Start free — DPDP included
            </Link>
            <a href="mailto:ceo@gravrel.com" className="bg-white/5 border border-white/20 text-white px-8 py-3.5 rounded-xl font-semibold hover:bg-white/10 transition-all">
