...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://gravrelaetherops.com/blog' },
  openGraph: { title: 'GravRel Blog', description: 'DPDP compliance, solar tech, AI tutorials for Indian developers.', url: 'https://gravrelaetherops.com/blog' },
};
...
const posts = [
  ...
  },
  {
    ...
    title: 'Free .gr.in Domains for Indian Students — How and Why',
    excerpt: 'Talent in India should never die due to lack of money. GravRel gives free yourproject.gr.in subdomains to students, researchers, open source contributors, and NGOs.',
    ...
    <main className="min-h-screen bg-[#0A1628] text-white">
      ...
      <section className="px-6 pb-20 max-w-5xl mx-auto">
        ...
        <div className="mt-16 text-center bg-[#0D2137] border border-[#1D9E75]/20 rounded-2xl p-10">
          ...
          <p className="text-gray-400 mb-6">Free developer docs, free .gr.in domain for students, India's most affordable DPDP-compliant cloud.</p>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-600">GravRel · Bhubaneswar, Odisha · ceo@gravrel.com · UDYAM-OD-03-0020346</p>
        </div>
      </section>
    </main>
  );
